        ...
        <div className={`bg-[#1f1e1e] text-[#FFFFFFB2] flex flex-col h-screen transition-all duration-300 border-r border-[#333333] ${isSidebarOpen ? 'w-80 md:w-96' : 'w-20'}`}>
            ...
            <div className="flex flex-col flex-1 overflow-y-auto py-4 px-4 text-md">
                <nav className="space-y-1">
                    ...
                    href="/attendance">
                       <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-calendar"><path d="M8 2v4"></path><path d="M16 2v4"></path><rect width="18" height="18" x="3" y="4" rx="2"></rect><path d="M3 10h18"></path></svg>
                    ...
                    <a className="flex items-center gap-3 rounded-md px-3 py-2  transition-colors hover:bg-[#333333] hover:text-white active:bg-[#333333] active:text-white " href="/results">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-users"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M22 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                    ...
                    <a className="flex items-center gap-3 rounded-md px-3 py-2  transition-colors hover:bg-[#333333] hover:text-white active:bg-[#333333] active:text-white " href="/leave">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-calendar"><path d="M8 2v4"></path><path d="M16 2v4"></path><rect width="18" height="18" x="3" y="4" rx="2"></rect><path d="M3 10h18"></path></svg>
                    ...
                    <a className="flex items-center gap-3 rounded-md px-3 py-2  transition-colors hover:bg-[#333333] hover:text-white active:bg-[#333333] active:text-white " href="/notifications">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-bell"><path d="M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9"></path><path d="M10.3 21a1.94 1.94 0 0 0 3.4 0"></path></svg>
                    ...
                    <a className="flex items-center gap-3 rounded-md px-3 py-2  transition-colors hover:bg-[#333333] hover:text-white active:bg-[#333333] active:text-white " href="/support">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-circle-help"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><path d="M12 17h.01"></path></svg>
